...
<%
            ...
            try {
                ...
                ResultSet rs = null;
                String a1 = "Update registration set name='" + na + "',secretquestion='"+se+"',answer='"+an+"',address='"+add+"',pincode='"+ pin+ "',phone='"+phone+"',email='"+email+"',village='"+vill+"',taluk='"+taluk+"',district='"+dis+"',state='"+state+"' where username='" + c1 + "'";
                st.executeUpdate(a1);
