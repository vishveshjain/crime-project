    ...
    try
            {
                ...
                ResultSet rs = st.executeQuery("select name,secretquestion,answer,address,pincode,phone,email,village,taluk,district,state from registration where username='" + c1 + "'");
                while (rs.next()) {
                    a = rs.getString("name");
                    b = rs.getString("secretquestion");
