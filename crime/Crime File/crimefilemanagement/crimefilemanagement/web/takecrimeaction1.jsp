...
<form id="form1" method="post" action="takecrimeaction2.jsp">
                                      
                                        
                                      <p>&nbsp;</p>
                                      <table width="443" border="1">
                                        <tr>
                                          <td width="175"><span class="style5">Crimeid</span></td>
                                          <td width="252"><label>
                                            <input type="text" name="crimeid" />
                                          </label></td>
                                        </tr>
                                        <tr>
                                          <td height="26"><span class="style5">Userid</span></td>
                                          <td><label>
                                            <input type="text" name="userid" />
                                          </label></td>
                                        </tr>
                                        <tr>
                                          <td><span class="style5">Take Action</span></td>
                                          <td><label>
