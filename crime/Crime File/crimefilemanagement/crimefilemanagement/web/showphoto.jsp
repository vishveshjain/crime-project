...
<form method="post" action="showphoto.jsp" name="upform" enctype="multipart/form-data">
  <table width="68%" border="0" cellspacing="1" cellpadding="1" align="center" class="style1">
    <tr>
      <td align="left"><b><span class="style4">Click here to See the photos.... , at C:Mostwanted,Missingperson Servers.... </span>a file to upload :</b></td>
    </tr>
    <tr>
      <td align="left">
