    ...
    <body>
        ...
        <div id="content">
            ...
            try {
                ...
                String userid = "", dsus = "", des = "", dat = "", crimetype = "";
                                        %>          
                                        
                                        <table width="495" height="49" border="1">
                                            <tr>
                                                <td width="86" height="43" ><span class="style5">User</span></td>
                                                <td width="89"><span class="style5">Detailssuspect</span></td>
                                                <td width="84"><span class="style5">Description</span></td>
                                                <td width="101"><span class="style5">Date</span></td>
                                                <td width="101"><span class="style5">Crimetype</span></td>
                                            </tr>
                                            <%
                                            while (rs.next()) {
                                                userid = rs.getString("userid");
                                                dsus = rs.getString("detailssuspect");
                                                des = rs.getString("Description");
                                                dat = rs.getString("Datc");
                                                crimetype = rs.getString("typeofcrime");
                                                out.println("<tr>");
                                                out.println("<td>" + userid + "</td>");
                                                out.println("<td>" + dsus + "</td>");
                                                out.println("<td>" + des + "</td>");
                                                out.println("<td>" + dat + "</td>");
                                                out.println("<td>" + crimetype + "</td>");
                                                out.println("<td><a href='takeaction.jsp?id=" +userid+"'>Reply</a></td>");
                                                out.println("<tr>");
                                            }
                                            %>
                                        </table>
