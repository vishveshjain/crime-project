...
<div id="content">
  ...
  <div id="colOne">
    <p>&nbsp;</p>
    <div>
		  <form id="form1" name="form1" method="post" action="newadminaction.jsp">
<%
            try {
                String user = request.getParameter("username");
                String pass = request.getParameter("password");
                String con = request.getParameter("conpass");
                String se = request.getParameter("select");
                String an = request.getParameter("answer");
                String na = request.getParameter("name");
                String de = request.getParameter("desig");
                String add = request.getParameter("offadd");
                ...
                //st.executeUpdate("insert into admnregistration values('" + user + "','"+se+"', '" + an + "','" + na + "','" + de + "','" + add + "'," + phone + ",'" + adr + "'," + pin + "," + phone1 + ",'" + email + "')");
