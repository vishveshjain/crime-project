         ...
         if ( (todo != null) && (todo.equalsIgnoreCase("upload")) )
         {
           ...
           if ( (files != null) && (!files.isEmpty()) )
           {
             UploadFile file = (UploadFile) files.get("uploadfile");
              if (file != null) out.println("<b> Successfully Uploaded the Mostwanted Person's photo : "+file.getFileName());
...
<form method="post" action="mwLargeUpload.jsp" name="upform" enctype="multipart/form-data">
