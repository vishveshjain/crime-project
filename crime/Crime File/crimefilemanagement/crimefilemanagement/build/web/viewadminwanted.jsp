    ...
    <h2>Welcome to crimeStation!</h2>
		<div>
            ...
            try {
                ...
                String name = "", age = "", address = "",typeofcrime="";
                                        %>          
                                        
                                        <table width="485" height="28" border="0">
                                            <tr>
                                                <td width="86" height="22" ><div align="center"><span class="style6"><strong>Name</strong></span></div></td>
                                                <td width="89"><div align="center" class="style10">Age</div></td>
                                                <td width="222"><div align="center"><span class="style6"><strong>Address</strong></span></div></td>
												 <td width="222"><div align="center" class="style6"><strong>Crime Type </strong></div></td>
												 <td width="222">&nbsp;</td>
												 <td width="222">&nbsp;</td>
                                            </tr>
                                            <%
                                            while (rs.next()) {
											  ...
											  typeofcrime = rs.getString("typeofcrime");
												...
												out.println("<td><a href='showphoto.jsp?id=" +name+"'>See Photo</a></td>");
												out.println("<td><a href='deletewanted.jsp?name=" +name+"'>Delete</a></td>");
