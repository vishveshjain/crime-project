        ...
        <div>
            ...
            <table width="485" height="28" border="0">
                <tr>
                    ...
                    <td width="89"><div align="center"><span class="style9 style6">Place</span></div></td>
                ...
                <%
        try {
            String namaddr1 = request.getParameter("namaddr");
            Class.forName("com.mysql.jdbc.Driver").newInstance();
            Connection con1 = DriverManager.getConnection("Jdbc:mysql://localhost/crimefile", "root", "");
            Statement st = con1.createStatement();
            Statement st1 = con1.createStatement();
            st1.executeUpdate("Delete from missingperson where namaddr='"+namaddr1+"'");
