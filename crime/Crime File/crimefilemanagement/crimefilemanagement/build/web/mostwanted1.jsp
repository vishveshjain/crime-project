...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div>
            ...
            <form method="post" action="mostwanted1.jsp" >
                <% try {
                ...
                while (rs.next()) {
                    ...
                    f = rs.getString("complexion");
                     g = rs.getString("hair");
                     h = rs.getString("built");
                   // String i = rs.getString("passportno");
                    //String j = rs.getString("casedescription");
                ...
                <table width="402" border="0">
                    ...
                    <tr>
                        <td width="189" height="37"><div align="right"><span class="style2">Name:</span></div></td>
                        <td width="197">
                            <label>
                                <input name="name" type="text" id="name" value='<%=b%>'/>
                        </label>    </td>
                    </tr>
                    <tr>
                        <td height="36"><div align="right">Age:</div></td>
                        <td><input name="age" type="text" id="age" value='<%=c%>'/></td>
                    </tr>
                    <tr>
                        <td height="40"><div align="right">Type of crime: </div></td>
                        <td><input name="type" type="text" id="type" value='<%=e%>'/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input name="complex" type="text" id="complex" value='<%=f%>'/></td>
                    </tr>
                    <tr>
                        <td height="35"><div align="right">Hair:</div></td>
                        <td><input name="hair" type="text" id="hair" value='<%=g%>'/></td>
                    </tr>
                    <tr>
                        <td height="33"><div align="right">Built:</div></td>
                        <td><input name="built" type="text" id="built" value='<%=h%>' /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td height="70" colspan="2"><div align="center"><a href="simple.jsp"></a></div></td>
                    </tr>
                    <tr>
