...
<%
            ...
            try {
                ...
                String type = request.getParameter("toi");
                String place1 = request.getParameter("place");
                String for1 = request.getParameter("for");
                String act = request.getParameter("select");
                String firno = request.getParameter("fno");
                String section1 = request.getParameter("sec");
                String refe = request.getParameter("refen");
                String infradd = request.getParameter("add");
                String passno = request.getParameter("pn");
                String comno = request.getParameter("cn");
                String police = request.getParameter("po");
